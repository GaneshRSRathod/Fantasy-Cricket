...
<button class= "button" onclick="document.getElementById('id01').style.display='block'" style="vertical-align:middle;"><span>Sign IN</span></button><br>

<div id="id01" class="modal">
  
  <form class="modal-content animate" action="new2.php" method="post">
...
<a href = "admin.php" ><button class = "button" style = "vertical-align:center"><span>Admin Login</span></button></a><br>
